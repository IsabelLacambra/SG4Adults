...
public class equipo03 : MonoBehaviour {
	...
	public GameObject puntosEq3;
	Puntos03 miPuntuacion3; 
	...
	void Start () {
		miPuntuacion3 = (Puntos03)puntosEq3.GetComponent (typeof(Puntos03));
	...
	void funcionlarga(){
		...
		if(string.Equals(ultimaClickada, "2")){
			...
			if(celdaInVecinos(vecinosMyPos,posicion)){
				if(miPuntuacion3.PuntosEq03>= 10) {
					Debug.Log("Fin");
